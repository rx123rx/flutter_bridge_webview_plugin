...
/** FlutterBridgeWebViewPlugin */
public class FlutterBridgeWebViewPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
  /** Plugin registration. */
  private Activity activity;
  private WebViewManager webViewManager;
  static MethodChannel channel;
  private static final String CHANNEL_NAME = "flutter_bridge_webview_plugin";

  public static void registerWith(PluginRegistry.Registrar registrar) {
    channel = new MethodChannel(registrar.messenger(), CHANNEL_NAME);
    final FlutterBridgeWebViewPlugin instance = new FlutterBridgeWebViewPlugin(registrar.activity());
    registrar.addActivityResultListener(instance);
    channel.setMethodCallHandler(instance);
  }

  private FlutterBridgeWebViewPlugin(Activity activity) {
  ...
  private void registerHandler(MethodCall call, MethodChannel.Result result) {
