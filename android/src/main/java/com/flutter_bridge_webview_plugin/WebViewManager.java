package com.flutter_bridge_webview_plugin;
...
import com.flutter_bridge_webview_plugin.bridge.BridgeForwarderImpl;
...
class WebViewManager {
    ...
    WebViewManager(final Activity activity) {
        ...
        ((ObservableWebView) webView).setOnScrollChangedCallback(new ObservableWebView.OnScrollChangedCallback() {
            public void onScroll(int x, int y, int oldx, int oldy) {
                ...
                FlutterBridgeWebViewPlugin.channel.invokeMethod("onScrollYChanged", yDirection);
                Map<String, Object> xDirection = new HashMap<>();
                xDirection.put("xDirection", (double) x);
                FlutterBridgeWebViewPlugin.channel.invokeMethod("onScrollXChanged", xDirection);
            }
        });
    ...
    void close(MethodCall call, MethodChannel.Result result) {
        ...
        closed = true;
        FlutterBridgeWebViewPlugin.channel.invokeMethod("onDestroy", null);
    }
    ...
    void registerHandler(MethodCall call, MethodChannel.Result result) {
        if (webView != null) {
            ObservableWebView.WVJBHandler<String, String> handler = new ObservableWebView.WVJBHandler<String, String>() {
                ...
                public void handler(String s, WVJBWebView.WVJBResponseCallback<String> wvjbResponseCallback) {
                    new BridgeForwarderImpl(activity).receiveMessageFromJs(s, wvjbResponseCallback);
                }
            };
            String handlerName = call.argument("handlerName");
